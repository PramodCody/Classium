...
class LevelsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF3F5F1), // Light background color. Change here to alter overall theme.

      // ---------------- APP BAR ----------------
      appBar: AppBar(
        backgroundColor: const Color(0xFF2E7D32), // AppBar color. Change to re-theme.
        elevation: 0,
        centerTitle: true,
        title: Text(
          "SELECT LEVEL",
      ...
      body: SafeArea(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            const int crossAxisCount = 2;   // Number of columns in the grid (levels 0-9).
            const int gridRowCount = 5;     // Number of rows in the grid (10 items / 2 columns).
            const double outerPaddingRatio = 0.05; // Padding around entire body, relative to width.
            const double spacingRatio = 0.02;      // Spacing between buttons, relative to height.
            ...
            final crossSpacing = usableWidth * 0.04;   // Horizontal gap between grid buttons.
            final mainSpacing = usableHeight * spacingRatio; // Vertical gap between grid rows.
            final gridToButton10Spacing = usableHeight * spacingRatio; // Gap before button 10.
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color(0xFF2E7D32), // Button color. Change to re-theme.
        elevation: 3,
        shadowColor: Colors.black45,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(12.0), // Corner roundness.
        ),
        padding: EdgeInsets.zero, // Padding removed so FittedBox controls sizing.
      ),
      child: FittedBox(
        fit: BoxFit.scaleDown, // Shrinks text if button is small, never overflows.
        child: Padding(
